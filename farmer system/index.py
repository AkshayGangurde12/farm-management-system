...
# Create Flask app
app = Flask(__name__)
app.secret_key = os.environ.get('SECRET_KEY', 'harshithbhaskar-production-key-2024')

# Database configuration - Use in-memory SQLite for serverless
...
with app.app_context():
    ...
    if not Farming.query.first():
        sample_farming = [
            Farming(farmingtype="Organic Farming"),
            Farming(farmingtype="Vegetable Farming"),
            Farming(farmingtype="Fruit Farming"),
            Farming(farmingtype="Grain Farming")
        ]
        for farming in sample_farming:
